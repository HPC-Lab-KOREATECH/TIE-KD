...
class DenseDepthHead_base_custom_kd(DepthBaseDecodeHead):
    """DenseDepthHead.
    ...
    def __init__(self,
                 ...
                 conv_dim=256,
                 **kwargs):
        super(DenseDepthHead_base_custom_kd, self).__init__(**kwargs)
    ...
    def forward(self, inputs, img_metas):
        ...
        up_feat = self.upsample_custom2(up_feat)
        output = self.depth_pred(up_feat)
        ##############
    ...
    def forward_train(self, img, inputs, img_metas, depth_gt, train_cfg,kd_gt):
        ...
        losses = dict()
        losses["loss_depth"] = self.loss_decode(depth_pred, kd_gt)
