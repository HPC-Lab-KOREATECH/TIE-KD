...
train_pipeline = [
    ...
    dict(type='KDLoadAnnotations_NYU'),
    dict(type='NYUCrop', depth=True),
    # dict(type='KBCrop', depth=True, height=480, width=640),
...
data = dict(
    ...
    val=dict(
        ...
        min_depth=1e-3,
        max_depth=10,
        kd_dir='gt_kd_depthformer_real_val'),
    test=dict(
        type=dataset_type,
        data_root=data_root,
        depth_scale=1000,
