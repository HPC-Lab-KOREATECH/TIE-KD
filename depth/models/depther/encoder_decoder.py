...
class DepthEncoderDecoder(BaseDepther):
    ...
    def _decode_head_forward_train(self, img, x, img_metas, depth_gt, kd_gt, **kwargs):
        # print("it's decode_head_forward_train")
        # sys.exit()
        """Run forward function and calculate loss for decode head in
        training."""
        losses = dict()
        loss_decode = self.decode_head.forward_train(img, x, img_metas, depth_gt, self.train_cfg, kd_gt, **kwargs)
    ...
    def forward_train(self, img, img_metas, depth_gt, kd_gt, **kwargs):
        ...
        loss_decode = self._decode_head_forward_train(img, x, img_metas, depth_gt, kd_gt, **kwargs)
