...
class NYUCrop(object):
    ...
    def __call__(self, results):
        ...
        kd_gt_cropped = results["kd_gt"][45:472, 43:608]
        results["kd_gt"] = kd_gt_cropped
...
class RandomCrop(object):
    ...
    def __call__(self, results):
        ...
        # results['kd_gt'] = np.transpose(results['kd_gt'], (1, 2, 0))         
        results['kd_gt'] = self.crop(results['kd_gt'], crop_bbox)
        results['kd_gt'] = np.expand_dims(results['kd_gt'],axis=0)
        
        # results['kd_gt'] = np.transpose(results['kd_gt'], (2, 0, 1)) 
        
        # print(results["depth_shape"])
        # print("=================")
        # print(results['kd_gt'].shape)
        ...
        ####
        # results['kd_gt'] = np.expand_dims(results['kd_gt'],axis=2)
        # print(results['kd_gt'].shape)
        # sys.exit()
        # print(results['kd_gt'].shape)
...
#                 results[key] = mmcv.imflip(
#                     results[key], direction=results['flip_direction']).copy()
#                 results['kd_gt'] = mmcv.imflip(results['kd_gt'], direction=results['flip_direction']).copy()
#                 # print(results['flip_direction'])
